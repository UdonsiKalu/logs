#!/bin/bash
# Setup script for GitHub Streak Automation

REPO_DIR="/home/udonsi-kalu/workspace"
LOG_FILE="/home/udonsi-kalu/workspace/logs/github_streak_setup.log"

echo "🚀 Setting up GitHub Streak Automation"
echo "======================================"
...
log_message "Starting GitHub streak setup..."
...
if git remote -v | grep -q origin; then
    ...
    echo "   git remote add origin https://github.com/udonsi-kalu/daily-streak.git"
    echo "   git push -u origin main"
fi

# Show current cron jobs
log_message "Current cron jobs:"
crontab -l | grep github_streak || log_message "No GitHub streak cron job found"
...
echo "✅ Streak script: /home/udonsi-kalu/workspace/startup-scripts/github_streak_advanced.sh"
...
if ! git remote -v | grep -q origin; then
    ...
    echo "✅ Ready to go! Your GitHub streak will start tomorrow at 6:00 AM"
fi

log_message "GitHub streak setup completed"
